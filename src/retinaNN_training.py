...
#Training settings
N_epochs = config.getint('training settings', 'N_epochs')
batch_size = config.getint('training settings', 'batch_size')
...
patches_imgs_train, patches_masks_train = get_data_training(
    ...
    N_subimgs = config.getint('training settings', 'N_subimgs'),
